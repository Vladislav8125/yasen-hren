...
function Icon({ children }: { children: React.ReactNode }) { return <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">{children}</svg>; }
const ICONS: Record<string, React.ReactNode> = {
  card: <Icon><rect x="4" y="2" width="12" height="16" rx="2" /><path d="M7 6h6M7 10h6M7 14h3" /></Icon>,
  mirror: <Icon><ellipse cx="10" cy="8" rx="6" ry="7" /><path d="M10 15v3M7 18h6" /></Icon>,
  shop: <Icon><path d="M5 7h10l-1 10H6L5 7z" /><path d="M7 7V5.5a3 3 0 016 0V7" /></Icon>,
  ask: <Icon><path d="M3 4.5h14v9H8l-4 4v-4H3v-9z" /></Icon>,
  tariff: <Icon><path d="M3 3h7l7 7-7 7-7-7V3z" /><circle cx="7" cy="7" r="1" fill="currentColor" stroke="none" /></Icon>,
