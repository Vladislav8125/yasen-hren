  ...
  return (
    <div className="flex flex-1 flex-col">
      <nav className="flex gap-4 border-b border-void-border bg-void-elevated px-6 py-3 font-technical text-xs uppercase tracking-widest">
        ...
        <Link href="/admin/shop" className="text-bone hover:text-gold-bright">
          Магазин
        </Link>
        <Link href="/admin/broadcast" className="text-bone hover:text-gold-bright">
          Рассылка
        </Link>
        <Link href="/admin/partners" className="text-bone hover:text-gold-bright">
          Партнёры
        </Link>
      </nav>
      {children}
